...
class Counter:
    ...
    def save_counters(self):
        ...
        with open('util/counters.txt', 'w') as f:
    ...
    def load_counters(self):
        ...
        if os.path.exists('util/counters.txt'):
            with open('util/counters.txt', 'r') as f:
...
class GearDemo:
    ...
    def run(self):
        ...
        pygame.font.init()
        self.font = pygame.font.Font('util/SourceCodePro-Regular.ttf', 12)
    ...
    def load_and_scale_gear_images(self):
        window_size = (780, 600)
        original_image = pygame.image.load("util/FinalGear.png")
...
class Input:
    ...
    @staticmethod
    def setup_database():
        conn = sqlite3.connect('util/deep_messages.db')
        cur = conn.cursor()
        cur.execute('''
